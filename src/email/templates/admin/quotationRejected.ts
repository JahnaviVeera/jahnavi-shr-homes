export function adminQuotationRejectedEmail(data: {
    customerName: string;
    projectName: string;
    reason?: string;
    frontendUrl: string;
    ...
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#f9fafb;padding:24px;border-radius:12px;">
      <h2 style="color:#7c3aed;">❌ Quotation Rejected</h2>
      <p>Hi Admin,</p>
      <p><strong>${data.customerName}</strong> has <strong style="color:#ef4444;">rejected</strong> the quotation for project <strong>${data.projectName}</strong>.</p>
