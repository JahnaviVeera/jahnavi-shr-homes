export function adminSupervisorMessageEmail(data: {
    ...
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#f9fafb;padding:24px;border-radius:12px;">
      <h2 style="color:#7c3aed;">💬 New Message from Supervisor</h2>
      <p>Hi Admin,</p>
      <p><strong>${data.supervisorName}</strong> (Supervisor) has sent you a new message:</p>
